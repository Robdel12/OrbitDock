    ...
    for envelope in &filtered {
        tx.execute(
            ...
            params![
                ...
                serde_json::to_string(&envelope.command)
                    .context("serialize sync command for audit log")?,
            ],
        )
        .with_context(|| {
            format!(
...
fn collect_touched_missions(
    ...
    match command {
        ...
        | crate::infrastructure::persistence::SyncCommand::SetCustomName {
            session_id: id, ..
        }
        ...
        | crate::infrastructure::persistence::SyncCommand::MarkSessionRead {
            session_id: id, ..
        }
        | crate::infrastructure::persistence::SyncCommand::ReactivateSession { id }
        | crate::infrastructure::persistence::SyncCommand::TokensUpdate {
            session_id: id, ..
        }
        | crate::infrastructure::persistence::SyncCommand::TurnStateUpdate {
            session_id: id, ..
        }
        | crate::infrastructure::persistence::SyncCommand::TurnDiffInsert {
            session_id: id, ..
        }
        ...
        | crate::infrastructure::persistence::SyncCommand::EffortUpdate {
            session_id: id, ..
        }
        | crate::infrastructure::persistence::SyncCommand::UpsertSubagent {
            session_id: id, ..
        }
        | crate::infrastructure::persistence::SyncCommand::UpsertSubagents {
            session_id: id, ..
        } => {
