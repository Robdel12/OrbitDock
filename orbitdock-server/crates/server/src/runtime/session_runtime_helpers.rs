...
//!
//! Shared helpers for runtime-side state transitions and direct-runtime
//! ownership. Transcript synchronization lives in `session_transcript_sync.rs`,
//! pure row/history helpers live in `session_row_history.rs`, and pure
//! time/path helpers live in `support/`.
...
pub(crate) use crate::runtime::transcript_sync_guard::{
  cached_transcript_sync_matches, next_transcript_sync_guard_state, remember_transcript_sync_guard,
