...
pub(crate) fn upgrade_row(row: ConversationRow) -> ConversationRow {
  match row {
    ...
    ConversationRow::Assistant(message) => upgrade_message_row(message, ConversationRow::Assistant),
    ConversationRow::Thinking(message) => upgrade_message_row(message, ConversationRow::Thinking),
