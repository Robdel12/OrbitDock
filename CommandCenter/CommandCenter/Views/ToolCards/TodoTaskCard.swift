...
struct TodoTaskCard: View {
    ...
    private var color: Color { Color(red: 0.65, green: 0.75, blue: 0.4) }  // Lime/olive
    ...
    private enum TaskOperation {
        ...
        var icon: String {
            ...
            case .get: return "doc.text.fill"
            case .unknown: return "checklist"
            }
        }
    ...
    private func statusStyle(_ status: String) -> (Color, String) {
        ...
        case "completed":
            return (Color(red: 0.3, green: 0.75, blue: 0.45), "checkmark")
        case "in_progress":
            return (Color(red: 0.4, green: 0.6, blue: 0.95), "arrow.right")
        case "pending":
            return (Color(red: 0.6, green: 0.6, blue: 0.6), "clock")
        case "deleted":
            return (Color(red: 0.9, green: 0.4, blue: 0.4), "trash")
        default:
            return (Color.secondary, "questionmark")
        }
    }
