...
struct EditCard: View {
    ...
    private var oldString: String { message.editOldString ?? "" }
    private var newString: String { message.editNewString ?? "" }
    private var writeContent: String? { message.writeContent }

    private var oldLines: [String] { oldString.components(separatedBy: "\n").filter { !$0.isEmpty } }
    private var newLines: [String] { newString.components(separatedBy: "\n").filter { !$0.isEmpty } }
    private var isTruncated: Bool { oldLines.count > 25 || newLines.count > 25 }
