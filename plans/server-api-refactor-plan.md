...
- `Slice 3N`: decide whether the conversation-semantics provider-event materialization path is a real near-term feature worth keeping parked, or whether it should be cut entirely instead of living behind comments and `dead_code`.
