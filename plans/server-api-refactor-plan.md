...
- `Slice 3M`: continue the one-by-one dead helper pass in conversation-semantics and remaining session/mission-control lanes, with extra care to separate honest future-facing placeholders from code that should now either be deleted or test-gated.
