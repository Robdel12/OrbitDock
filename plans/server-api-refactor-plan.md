...
- `Slice 3L`: continue the one-by-one dead helper pass in mission-control/runtime/tool-PTY lanes, with extra care to separate honest future-facing placeholders from code that should now either be deleted or test-gated.
